...
export class CourseCreateComponent implements OnInit {
  ...
  timesUntil: Array<Time>;
    ...
    public mustHavePeriodNumber() : boolean {
      let periodType = this.formPeriodType.value;
    ...
    public createCourse() {
       ...
       this.coursesService.createCourse(this.formName.value, this.formShift.value, this.formYear.value,this.formPeriodType.value, 
        this.formPeriodNumber.value, this.formTimeSince.value, this.formTimeUntil.value, this.formCareerId.value, this.formChair.value)
        .then(() => {
            this.loading = false;
            this.backToCourses();
        }, err => {
  	...
  	get formCareerId() { return this.form.get('careerId'); }
